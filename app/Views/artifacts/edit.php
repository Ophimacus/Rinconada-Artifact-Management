            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="model_file" class="form-label">
                        <?= !empty($artifact['model_file_path']) ? 'Replace File' : 'Upload File' ?>
                    </label>
                    ...
                    <div class="form-text">
                        <?php if (!empty($artifact['model_file_path'])): ?>
                            <div class="mt-2">
                                <strong>Current file:</strong> <?= basename($artifact['model_file_path']) ?>
                                (<?= !empty($artifact['model_file_size_kb']) ? number_format($artifact['model_file_size_kb'] / 1024, 2) . ' MB' : 'N/A' ?>)<br>
                                <a href="<?= base_url($artifact['model_file_path']) ?>" class="btn btn-sm btn-outline-primary mt-1" download>
                                    <i class="fas fa-download me-1"></i> Download
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-danger mt-1" 
                                        onclick="if(confirm('Are you sure you want to remove this file?')) { document.getElementById('remove_file').value = '1'; this.closest('form').submit(); }">
